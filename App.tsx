      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-card-dark/90 backdrop-blur-md border-b border-[#ccfbf1] dark:border-teal-900 px-6 py-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm font-medium text-teal-900 dark:text-teal-50">Nâng cấp bài giảng tự động - phát triển bởi cô Hồ Thị Thùy Linh</p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="space-y-2 text-sm md:text-base">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
              <a
                href="https://www.facebook.com/profile.php?id=100069874768587"
                target="_blank"
                rel="noreferrer"
